    ...
    <footer className="bg-white border-t mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">CrowdChain</h3>
            <p className="text-gray-600">Decentralized crowdfunding platform for innovative projects.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-indigo-600">Start a Project</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600">Discover</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600">How it Works</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600">For Creators</a></li>
            </ul>
          </div>
