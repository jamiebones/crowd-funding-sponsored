...
export async function POST(request: NextRequest) {
    try {
        ...
        const { description, uploadIds } = body as {
            description: string;
            ...
            const uploadResult = await turbo.uploadFile({
                ...
                dataItemOpts: {
                    tags: [
                        ...
                        { name: 'File-Type', value: 'milestone-media' },
        ...
        const uploadResult = await turbo.uploadFile({
            ...
            dataItemOpts: {
                tags: [
                    ...
                    { name: 'App-Name', value: 'CrowdFunding' },
                    { name: 'Data-Type', value: 'milestone-content' },
                ],
            },
        });
        ...
        console.error('Finalize milestone upload error:', error);
        return NextResponse.json(
            {
                error: 'Failed to finalize milestone upload',
